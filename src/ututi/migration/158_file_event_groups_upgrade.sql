...
UPDATE events SET parent_id = null WHERE event_type = 'file_uploaded';
select event_set_group(e.*) FROM events e WHERE e.event_type = 'file_uploaded' ORDER BY e.created asc;
