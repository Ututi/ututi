...
ALTER TABLE ONLY content_items
    ADD CONSTRAINT content_items_location_id_fkey FOREIGN KEY (location_id) REFERENCES tags(id)  ON DELETE CASCADE;
...
ALTER TABLE ONLY user_registrations
    ADD CONSTRAINT user_registrations_location_id_fkey FOREIGN KEY (location_id) REFERENCES tags(id)  ON DELETE CASCADE;
