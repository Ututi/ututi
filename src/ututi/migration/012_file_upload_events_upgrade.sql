...
DROP TRIGGER subject_file_event_trigger ON subject_files;
DROP TRIGGER group_file_event_trigger ON group_files;

DROP FUNCTION subject_file_event_trigger();
DROP FUNCTION group_file_event_trigger();
