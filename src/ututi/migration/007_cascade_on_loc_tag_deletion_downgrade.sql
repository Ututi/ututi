...
ALTER TABLE ONLY tags
    ADD CONSTRAINT tags_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES tags(id);


ALTER TABLE ONLY public.content_items DROP CONSTRAINT content_items_location_id_fkey;

ALTER TABLE ONLY content_items
    ADD CONSTRAINT content_items_location_id_fkey FOREIGN KEY (location_id) REFERENCES tags(id);
