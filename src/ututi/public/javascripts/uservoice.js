...
this.options.tab_string={cn:"反馈",de:"Feedback",es:"Sugerencias",fr:"Commentaires",ja:"フィードバック",nl:"Feedback",pt_BR:"Comentário"};this.options.text_url=UserVoice.Util.getAssetHost()+'/images/widgets/'+this.options.lang+'/feedback_tab_'+this.options.text_color+'.png';this.options.id=this.id;}}
